...
contract DeployYourContract is Script {
    ...
    function run() public {
        ...
        if (block.chainid == 31337) {
            ...
            console.logString(
                string.concat(
                    "Mock USDT deployed at: ",
                    vm.toString(usdtAddress)
                )
            );
            console.logString(
                string.concat(
                    "Mock USDC deployed at: ",
            ...
            revert(
                "Unsupported network. Please use localhost (31337) or Sepolia (11155111)"
            );
        }
